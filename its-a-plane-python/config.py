...
def _apply():
    ...
    # Keyless. Shows the OFFICIAL observed AQI for your EPA reporting area (the
    # number airnow.gov shows), falling back to Open-Meteo's modelled value only
    # if that's unavailable — see utilities/air_quality.py.
