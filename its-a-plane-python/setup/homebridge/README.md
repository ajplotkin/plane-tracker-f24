...
The same ATC on/off switch (and the tracker nightlight) is exposed as a
**Matter bridge** via Home Assistant + Matterbridge running on the hub Pi
(raspberrypi-eh) — pair it once in Google Home and once in Apple Home and
both get native tiles/voice/routines. Setup, pairing codes, and entity
details: `docs/Raspberry Pi EH - Services.md`. The scripts below remain the
plain-Homebridge alternative for HomeKit-only setups.

## Canonical switch semantics (AJ, 2026-07-02)
